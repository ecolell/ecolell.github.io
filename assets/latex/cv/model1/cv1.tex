...
\item[2014--    ] Universidad Nacional del Noroeste de la Provincia de Buenos Aires
  \begin{itemize}
  \item Master en Bioinform{\'a}tica y Biolog{\'i}a de Sistemas \\ (576 hs / Tésis en desarrollo )
  \end{itemize}
\end{CV}
...
\item[Scripting] javascript (angularjs, jquery, knockoutjs, lodash, nginx, prototype, protractor, webpack), lisp, lua, octave, perl, php, prolog, python (django, flask, mocker, pytest, sqlalchemy), ruby (rails 5.1), smalltalk (seaside, meteoroid), xml, xsl
\item[Compiled] assembly, c/c++, (boost, asio, stl, lpc1343), delphi, java (android), objective-c (ios), \LaTeX, visual basic
